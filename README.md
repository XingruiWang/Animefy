...
| [StyleGAN2 on animate characters](https://drive.google.com/uc?id=19vr5taIJSbNMiqihW1-vWSZkXUK7tdPR) | Our final result to generate animate faces and also to project real-world human faces, namely `G_out.pth`. |
