...
def main(): 
    G_out = blend_models("checkpoints/stylegan2_512x512_with_pretrain/pretrain/Gs.pth", "checkpoints/stylegan2_512x512_with_pretrain_new_2/20000_2020-12-23_13-17-51/Gs.pth", 32, None)
